            ...
            <div class="col-xl-12 col-lg-12 order-lg-2 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <form action="{{ route('kelas.tambahKelas') }}" method="post">
                            @csrf

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" name="kelas"
                                    placeholder="" />
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingWaliKelas" name="jurusan" placeholder="">
                                    <option selected disabled>Open this select menu</option>
                                    @forelse ($jurusans as $jurusan)
                                        <option value="{{ $jurusan->id }}">{{ $jurusan->jurusan_id_str }}
                                        </option>
                                    @empty
                                        <option>Jurusan Belum Di Import Dari Dapodik atau Ditambahkan ke Databse Local
                                        </option>
                                    @endforelse
                                </select>
