                                    ...
                                    <tr>
                                        <th colspan="4">
                                            <div class="d-flex card-header justify-content-between align-items-center">
                                                ...
                                                <a href="{{ Route('adminPKL.maping', $pkl_id) }}"
                                ...
                                <tbody>
                                    @forelse ($Siswa as $index => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('adminPKL.store') }}" method="post">
                                                    ...
                                                    <input type="hidden" name="pd_id" value="{{ $item->id }}">
                                    ...
                                    @empty
                                        <tr>
                                            <td>
                                                ...
                                                <span class="text-muted font-13">Penaggung Jawab</span>
                                            </td>
