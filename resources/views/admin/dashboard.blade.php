...
@section('pluginsJS')
    ...
    <script>
        var options = {
            series: [{!! $guruHadir !!}, {!! $guruSakit !!}, {!! $guruIzin !!}, {!! $guruAlfa !!},
                {!! $guruTugas !!}
            ],
            chart: {
                height: 350,
    ...
    <script>
        var options = {
            series: [{!! $hadirHariIni !!}, {!! $sakitHariIni !!}, {!! $izinHariIni !!},
                {!! $alfaHariIni !!}
            ],
            chart: {
                height: 350,
    ...
    <script>
        var options = {
            series: [{!! $pklHadir !!}, {!! $pklSakit !!}, {!! $pklIzin !!},
                {!! $pklAlfa !!},
                {!! $pklTugas !!}
            ],
            chart: {
        ...
        var chart = new ApexCharts(document.querySelector("#kehadiran-PKL"), options);
        chart.render();
    </script>
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
                            ...
                            <table class="table table-centered table-nowrap table-hover mb-0">
                                <tbody>
                                    @forelse ($presensiGuru as $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span
                                                    class="text-muted font-15 fw-bold">{{ $data->pembelajaran->namaPelajaran }}</span>
                                                <br>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5">
                                                <h5 class="font-14 my-1 fw-normal text-capitalize">belum ada data presensi
                                                </h5>
                                            </td>
                                        </tr>
                                    @endforelse
        ...
        <div class="row" id="PresensiPKL">
            <div class="col-xl-12col-lg-12 order-lg-2 order-xl-1">
                <div class="card card-h-100">
                    <div class="d-flex card-header justify-content-between align-items-center">
                        <h4 class="header-title">Presentase Kehadiran PKL Hari Ini</h4>
                    </div>
                    <div class="card-body pt-0">
                        <div dir="ltr">
                            <div id="kehadiran-PKL" class="apex-charts" data-colors="#727cf5,#e3eaef"></div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="table-responsive" style="max-height: 320px;height: 320px;">
                            <table class="table table-centered table-nowrap table-hover mb-0">
                                <tbody>
                                    @forelse ($presensipkl as $data)
                                        <tr>
                                            <td>
                                                <h5 class="font-14 my-1 fw-normal">Nama Siswa</h5>
                                                <span class="text-muted font-13">{{ $data->siswa->name }}</span>
                                            </td>
                                            <td>
                                                <h5 class="font-14 my-1 fw-normal">Tempat PKL</h5>
                                                <span class="text-muted font-15 fw-bold">{{ $data->tempat->nama }}</span>
                                                <br>
